...
function DOT() {}
/** @override */
DOT.prototype.draw = function(gc, x, y, colour) {
...
function BUY() {}
/** @override */
BUY.prototype.draw = function(gc, x, y, colour) {
    let xs = new Array(6);
    let ys = new Array(6);
    xs[0] = x;
    ys[0] = y + 3;
...
function SELL() {}
/** @override */
SELL.prototype.draw = function(gc, x, y, colour) {
    let xs = new Array(6);
    let ys = new Array(6);
    xs[0] = x;
    ys[0] = y - 3;
...
function EXITBUY() {}
/** @override */
EXITBUY.prototype.draw = function(gc, x, y, colour) {
    let xs = new Array(12);
    let ys = new Array(12);
    xs[0] = x - 5;
    ys[0] = y + 4;
...
function EXITSELL() {}
/** @override */
EXITSELL.prototype.draw = function(gc, x, y, colour) {
    let xs = new Array(12);
    let ys = new Array(12);
    xs[0] = x - 5;
    ys[0] = y - 4;
...
GIRELLA.prototype.draw = function(gc, x, y, colour) {
    let xoffset = gc._gc.measureText("@").width;
    if (colour) {
