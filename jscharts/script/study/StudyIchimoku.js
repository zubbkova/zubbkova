...
StudyIchimoku.prototype.draw = function() {
    ...
    let startx = this._parent.getXOffScale(this._senkuoSpan1.timeByIndex(0));
    let y1 = this._parent.getY(this._senkuoSpan1.getByIndex(0));
    let y2 = this._parent.getY(this._senkuoSpan2.getByIndex(0));
    for (let n = 0; n < this._senkuoSpan1.size(); n++) {
...
StudyIchimoku.prototype._drawSenkuoLine = function(s, col) {
    ...
    let startx = this._parent.getXOffScale(s.timeByIndex(0));
    let starty = this._parent.getY(s.getByIndex(0));
    for (let n = 1; n < this._senkuoSpan1.size(); n++) {
