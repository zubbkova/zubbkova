    ...
    switch (this._status) {
        ...
        case StudyCCI.LONG :
            if (cci < 100) {
                ...
                this._parent._chartCanvas._chart._signals.addBuyExit(date);
            }
            break;
        case StudyCCI.SHORT :
            if (cci > -100) {
                this._status = StudyCCI.READY;
                this._parent._chartCanvas._chart._signals.addSellExit(date);
            }
            break;
    }
}
...
StudyCCI.prototype.draw = function() {
    ...
    let y = parseInt(this._parent.getY(100.0), 10);
