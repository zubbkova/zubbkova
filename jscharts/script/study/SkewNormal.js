...
SkewNormal.prototype.erf = function(x) {
    ...
    let y = x * x;
    let num = SkewNormal.p10 + y * (SkewNormal.p11 + y * (SkewNormal.p12 + y * SkewNormal.p13));
    let den = SkewNormal.q10 + y * (SkewNormal.q11 + y * (SkewNormal.q12 + y * SkewNormal.q13));
    return x * num / den;
}
