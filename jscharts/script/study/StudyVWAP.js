...
StudyVWAP.prototype.draw = function() {
    ...
    this._parent.drawPrice(this._close.get(this._parent._chartCanvas._chart._currentSymbol._timeEnd), this._colour);
}
/** @override */
...
StudyVWAP.prototype.setParams = function(params) {
    ...
    if (items.has("lineType"))
        this._lineType = parseInt(items.get("lineType"), 10);
