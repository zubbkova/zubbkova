...
/* global Study, Language, MetaStudy, Chart */
/**
 * @constructor
 * @extends {Study}
 * @param {Overlay} o
...
StudyMx.prototype.update = function(start, end) {
    this._series = MetaStudy.offsetSeries(this._parent._chart, MetaStudy.SMA(this._parent._chart, this._parent._chart.getSeries(Chart.S_CUR_CLOSE), 3), -3);
}
/** @override */
StudyMx.prototype.drawPrice = function() {
