/* global Study, Series, Language, Utils, TimeIterator, StudyDialog_StudyEditParameter, Color, StudySymbol */
/**
 * @constructor
 * @extends {Study}
 * @param {Overlay} o
...
StudySAR.prototype.setParams = function(params) {
    ...
    if (items.hasOwnProperty("acceleration") && typeof items["acceleration"] !== "undefined")
        this._acceleration = parseFloat(items["acceleration"]);
    if (items.hasOwnProperty("maxacc") && typeof items["maxacc"] !== "undefined")
        this._maxacc = parseFloat(items["maxacc"]);
...
StudySAR.prototype.update = function(start, end) {
    ...
    var low1 = Number.MAX_SAFE_INTEGER;
    var sar1 = 0.0;
    var position_long = true;
    var acc = this._acceleration;
    var n = 0;
    var newtrade = true;
    var highVal, lowVal, sar;
    do {
