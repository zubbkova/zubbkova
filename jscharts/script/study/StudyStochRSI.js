...
StudyStochRSI.prototype.update = function(start, end) {
    ...
    var high = 0.0, low = 999999.99;
    var RSI = 0.0, StochRSI = 0.0;
    this._series.clear();
    ...
    do {
        diff = this._source.get(i._d) - this._source.get(this._parent._chart.timeAdjust(i._d, -1));
        if (diff > 0.0) {
...
StudyStochRSI.prototype.draw = function() {
    ...
    var y = parseInt(this._parent.getY(0.3), 10);
