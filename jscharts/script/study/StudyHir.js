...
StudyHir.prototype.draw = function() {
    ...
    this._parent.drawPrice(this._hir.get(this._parent._chartCanvas._chart._currentSymbol._timeEnd), Color.green);
    this._parent.drawLineNormal(this._movingZero, Color.red);
    this._parent.drawPrice(this._movingZero.get(this._parent._chartCanvas._chart._currentSymbol._timeEnd), Color.red);
}