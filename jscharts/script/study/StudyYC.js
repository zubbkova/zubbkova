...
StudyYC.prototype.getMaxMin = function(i) {
    this._range.reset();
    this._price = this._parent._chart._currentSymbol.getSymbolInfo(0).getYesterdaysClose();
    if (this._parent._chart._showYestClose && this._price > 0) {
...
/** @override */
StudyYC.prototype.drawPrice = function() {
    this._parent.drawPrice(this._price, Color.red);
}
/** @override */
StudyYC.prototype.draw = function() {
    if (!this._parent._chart._showYestClose || this._price <= 0.0)
        return;
    var y = this._parent.getY(this._price);
    this.updateY();
