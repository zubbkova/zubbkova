...
StudyMom.prototype.update = function(start, end) {
    ...
    do {
        if (this._source.get(this._parent._chartCanvas._chart.timeAdjust(i._d, -this._period)) !== 0.0)
            this._series.append(i._d, this._source.get(i._d) - this._source.get(this._parent._chartCanvas._chart.timeAdjust(i._d, -this._period)));
    } while (i.move());
}