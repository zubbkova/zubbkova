...
/* global Study, Series, Language, MetaStudy, XTIterator, Color */
/**
 * @constructor
 * @extends {Study}
 * @param {Overlay} o
...
StudyZone.prototype.draw = function() {
    this.updateY();
    if (typeof this._greenTest === "undefined" || typeof this._redTest === "undefined")
        return;
    var c = this._parent._chart;
    ...
    do {
        ...
        var hy = this._parent.getY(this._high.get(i._d));
        var ly = this._parent.getY(this._low.get(i._d));
        var cx = parseInt(c._currentSymbol._unitWidth, 10) / 2;
