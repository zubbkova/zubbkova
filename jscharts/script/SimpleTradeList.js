/* global TradeList, FeedRequest, Feed, Utils, FeedContent */
/**
 * ---------------
 * SimpleTradeList
 * ---------------
...
function SimpleTradeList(id, params, feedSymbol) {
    ...
    var fr = new FeedRequest("tradelist");
...
/** @override */
SimpleTradeList.prototype.process = function() {
...
SimpleTradeList.prototype._tradeAdd = function(pos) {
    var tid = (this._nextID++).toString();
    var t = new SimpleTradeList_Trade();
    t.load(this._line);
    t._id = tid;
