/* global Component, ChartEvent, Color */
/**
 * ----
 * Tabs
 * ----
...
Tabs.prototype.draw = function(force) {
    ...
    if (this._drawTable) {
        ...
        var str = "<div id=\"" + this._tableID + "\" align=\"left\">";
    ...
    if (this._drawButtons) {
        ...
        for (i = 0; i < this._tabs.length; i++) {
            ...
            e.on("touchend", undefined, i, function(e) { self._handleClick(e); });
...
Tabs.prototype.onClick = function(tab) {
    var e = new ChartEvent(ChartEvent.TAB_SELECT);
    e._data = tab;
    this.notify(e);
}
/**
