...
Strings.snews = function() {
    Strings.table["datetime"] = "Time";
    Strings.table["source"] = "Source";
    Strings.table["headline"] = "Headline";
    Strings.table["symbol"] = "Symbol";
    Strings.table["symbol_name"] = "Company";
}
/**
 * @param {number} i
 * @param {string} s
