...
HotTickerFrame.prototype.setOriginalBounds = function() {
    let x = this._parentBounds._x + (this._hotTicker._posX > 0 ? this._hotTicker._posX : (this._parentBounds._width + this._hotTicker._posX));
    let y = this._parentBounds._y + (this._hotTicker._posY > 0 ? this._hotTicker._posY : (this._parentBounds._height + this._hotTicker._posY));
