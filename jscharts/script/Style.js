...
Style.getBackground = function(style) {
    let bg = undefined;
    let myLang = Language.getLanguageID();
    if(myLang) {
        bg = Style._internationalBackground.get(myLang + style);
    }
...
Style.getForeground = function(style) {
    ...
    let myLang = Language.getLanguageID();
    if (myLang) {
        fg = Style._internationalForeground.get(myLang + style);
    }
...
Style.getFontByStyle = function(style) {
    let fsize = (   Style._fontSize[style] === -1) ? Style._fontSize[Style.DEFAULT] : Style._fontSize[style];
    let fstyle = (Style._fontStyle[style] === -1) ? Style._fontStyle[Style.DEFAULT] : Style._fontStyle[style];
    return Style._font[Style._fontNum[fstyle][fsize]];
}
/**
 * @param {number} f
...
Style.start = function() {
    ...
    Style._fontSize = new Array(Style.MAX_STYLES).fill(-1);
    Style._fontStyle = new Array(Style.MAX_STYLES).fill(-1);
    ...
    Style._internationalForeground = new Map();
    Style._internationalBackground = new Map();
    for (let l of Style._languages) {
        Style._internationalForeground.set(l + Style.DEFAULT, Style._foreground[Style.DEFAULT]);
	    Style._internationalForeground.set(l + Style.HIGHLIGHT_UP, Style._foreground[Style.HIGHLIGHT_UP]);
	    Style._internationalForeground.set(l + Style.HIGHLIGHT_DOWN, Style._foreground[Style.HIGHLIGHT_DOWN]);
	    Style._internationalForeground.set(l + Style.PERIOD_UP, Style._foreground[Style.PERIOD_UP]);
	    Style._internationalForeground.set(l + Style.PERIOD_NO_CHANGE, Style._foreground[Style.PERIOD_NO_CHANGE]);
	    Style._internationalForeground.set(l + Style.PERIOD_DOWN, Style._foreground[Style.PERIOD_DOWN]);
	    Style._internationalForeground.set(l + Style.TABLE_HEADING, Style._foreground[Style.TABLE_HEADING]);
	    Style._internationalForeground.set(l + Style.HIGHLIGHT_INSERT, Style._foreground[Style.HIGHLIGHT_INSERT]);
	    Style._internationalForeground.set(l + Style.HIGHLIGHT_DELETE, Style._foreground[Style.HIGHLIGHT_DELETE]);
	    Style._internationalForeground.set(l + Style.DELETED, Style._foreground[Style.DELETED]);
	    Style._internationalForeground.set(l + Style.HIGHLIGHT_SELECTED, Style._foreground[Style.HIGHLIGHT_SELECTED]);
	    Style._internationalForeground.set(l + Style.TOUCH_UP, Style._foreground[Style.TOUCH_UP]);
	    Style._internationalForeground.set(l + Style.TOUCH_DOWN, Style._foreground[Style.TOUCH_DOWN]);
	    Style._internationalForeground.set(l + Style.MONITOR_HEADER, Style._foreground[Style.MONITOR_HEADER]);
	    Style._internationalForeground.set(l + Style.MONITOR_SUB_HEADER, Style._foreground[Style.MONITOR_SUB_HEADER]);
	    Style._internationalBackground.set(l + Style.DEFAULT, Style._background[Style.DEFAULT]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_UP, Style._background[Style.HIGHLIGHT_UP]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_NO_CHANGE, Style._background[Style.HIGHLIGHT_NO_CHANGE]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_DOWN, Style._background[Style.HIGHLIGHT_DOWN]);
	    Style._internationalBackground.set(l + Style.TABLE_HEADING, Style._background[Style.TABLE_HEADING]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_INSERT, Style._background[Style.HIGHLIGHT_INSERT]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_DELETE, Style._background[Style.HIGHLIGHT_DELETE]);
	    Style._internationalBackground.set(l + Style.DELETED, Style._background[Style.DELETED]);
	    Style._internationalBackground.set(l + Style.PRICE_1, Style._background[Style.PRICE_1]);
	    Style._internationalBackground.set(l + Style.PRICE_2, Style._background[Style.PRICE_2]);
	    Style._internationalBackground.set(l + Style.PRICE_3, Style._background[Style.PRICE_3]);
	    Style._internationalBackground.set(l + Style.PRICE_4, Style._background[Style.PRICE_4]);
	    Style._internationalBackground.set(l + Style.PRICE_5, Style._background[Style.PRICE_5]);
	    Style._internationalBackground.set(l + Style.PRICE_MARKET, Style._background[Style.PRICE_MARKET]);
	    Style._internationalBackground.set(l + Style.PRICE_EVEN, Style._background[Style.PRICE_EVEN]);
	    Style._internationalBackground.set(l + Style.TRADE_EVEN, Style._background[Style.TRADE_EVEN]);
	    Style._internationalBackground.set(l + Style.TRADE_OLD_ODD, Style._background[Style.TRADE_OLD_ODD]);
	    Style._internationalBackground.set(l + Style.TRADE_OLD_EVEN, Style._background[Style.TRADE_OLD_EVEN]);
	    Style._internationalBackground.set(l + Style.TRADE_LARGE_ODD, Style._background[Style.TRADE_LARGE_ODD]);
	    Style._internationalBackground.set(l + Style.TRADE_LARGE_EVEN, Style._background[Style.TRADE_LARGE_EVEN]);
	    Style._internationalBackground.set(l + Style.ORDERBOOK_LARGE_ODD, Style._background[Style.ORDERBOOK_LARGE_ODD]);
	    Style._internationalBackground.set(l + Style.ORDERBOOK_LARGE_EVEN, Style._background[Style.ORDERBOOK_LARGE_EVEN]);
	    Style._internationalBackground.set(l + Style.TRADE_OLD_HEADER, Style._background[Style.TRADE_OLD_HEADER]);
	    Style._internationalBackground.set(l + Style.MONITOR_ODD, Style._background[Style.MONITOR_ODD]);
	    Style._internationalBackground.set(l + Style.MONITOR_EVEN, Style._background[Style.MONITOR_EVEN]);
	    Style._internationalBackground.set(l + Style.MONITOR_HEADER, Style._background[Style.MONITOR_HEADER]);
	    Style._internationalBackground.set(l + Style.MONITOR_SUB_HEADER, Style._background[Style.MONITOR_SUB_HEADER]);
	    Style._internationalBackground.set(l + Style.HIGHLIGHT_SELECTED, Style._background[Style.HIGHLIGHT_SELECTED]);
	    Style._internationalBackground.set(l + Style.TOUCH, Style._background[Style.TOUCH]);
	    Style._internationalBackground.set(l + Style.TOUCH_UP, Style._background[Style.TOUCH_UP]);
	    Style._internationalBackground.set(l + Style.TOUCH_NO_CHANGE, Style._background[Style.TOUCH_NO_CHANGE]);
	    Style._internationalBackground.set(l + Style.TOUCH_DOWN, Style._background[Style.TOUCH_DOWN]);
	    Style._internationalBackground.set(l + Style.TOOL_AREA, Style._background[Style.TOOL_AREA]);
	    Style._internationalBackground.set(l + Style.TABLE_ODD_ROW, Style._background[Style.TABLE_ODD_ROW]);
	    Style._internationalBackground.set(l + Style.TABLE_EVEN_ROW_HIGHLIGHT, Style._background[Style.TABLE_EVEN_ROW_HIGHLIGHT]);
	    Style._internationalBackground.set(l + Style.TABLE_ODD_ROW_HIGHLIGHT, Style._background[Style.TABLE_ODD_ROW_HIGHLIGHT]);
    }
    Style._internationalForeground.set("jp" + Style.PERIOD_UP, Color.red);
    Style._internationalForeground.set("jp" + Style.PERIOD_NO_CHANGE, Color.darkBlue1);
    Style._internationalForeground.set("jp" + Style.PERIOD_DOWN, Color.green);
    Style._internationalBackground.set("jp" + Style.HIGHLIGHT_UP, Color.red);
    Style._internationalBackground.set("jp" + Style.HIGHLIGHT_DOWN, Color.green);
    Style._internationalForeground.set("it" + Style.PERIOD_UP, Color.green);
    Style._internationalForeground.set("it" + Style.PERIOD_NO_CHANGE, Color.darkBlue1);
    Style._internationalForeground.set("it" + Style.PERIOD_DOWN, Color.red);
    Style._internationalBackground.set("it" + Style.HIGHLIGHT_UP, Color.green);
    Style._internationalBackground.set("it" + Style.HIGHLIGHT_DOWN, Color.red);
    Style._internationalForeground.set("fr" + Style.PERIOD_UP, Color.green);
    Style._internationalForeground.set("fr" + Style.PERIOD_NO_CHANGE, Color.darkBlue1);
    Style._internationalForeground.set("fr" + Style.PERIOD_DOWN, Color.red);
    Style._internationalBackground.set("fr" + Style.HIGHLIGHT_UP, Color.green);
    Style._internationalBackground.set("fr" + Style.HIGHLIGHT_DOWN, Color.red);
    Style._internationalForeground.set("de" + Style.PERIOD_UP, Color.green);
    Style._internationalForeground.set("de" + Style.PERIOD_NO_CHANGE, Color.darkBlue1);
    Style._internationalForeground.set("de" + Style.PERIOD_DOWN, Color.red);
    Style._internationalBackground.set("de" + Style.HIGHLIGHT_UP, Color.green);
    Style._internationalBackground.set("de" + Style.HIGHLIGHT_DOWN, Color.red);
    Style._internationalForeground.set("us" + Style.PERIOD_UP, Color.green);
    Style._internationalForeground.set("us" + Style.PERIOD_NO_CHANGE, Color.black);
    Style._internationalForeground.set("us" + Style.PERIOD_DOWN, Color.red);
    Style._internationalBackground.set("us" + Style.HIGHLIGHT_UP, Color.green);
    Style._internationalBackground.set("us" + Style.HIGHLIGHT_DOWN, Color.red);
